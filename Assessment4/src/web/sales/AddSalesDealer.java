...
/**
 * Servlet implementation class AddSalesDealer
 */
@WebServlet("/AddSalesDealer")
public class AddSalesDealer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSalesDealer() {
        super();
	...
	collection.insertOne(document);
		request.getRequestDispatcher("AddSalesDealer.jsp").forward(request, response);
